      ...
      metrics={[
        {
          ...
          description: "A long-standing reputation built on reliability.",
          icon: Award,
        },
        {
          id: "pillar-2",
          ...
          description: "The preferred choice for a thriving community.",
          icon: Users,
        },
        {
          id: "pillar-3",
          ...
          description: "Unmatched accessibility for all stakeholders.",
          icon: MapPin,
        },
        {
          id: "pillar-4",
          value: "Diverse",
          title: "Service Hub",
          description: "Offices, banquets, banking & diagnostics in one place.",
          icon: Lightbulb,
        },
      ]}
